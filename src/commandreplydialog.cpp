...
#include "ui_commandreplydialog.h"

CommandReplyDialog::CommandReplyDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CommandReplyDialog)
{
    ui->setupUi(this);
}

CommandReplyDialog::~CommandReplyDialog()
{
    delete ui;
}

void CommandReplyDialog::setText(QString text) {
